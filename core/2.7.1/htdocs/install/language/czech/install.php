...
define('_WEBSITE_NAME', 'XOOPS');
define('_WEBSITE_SLOGAN', 'Stačí to použít!');
define('_WEBSITE_META_KEYWORDS', 'xoops, framework webové aplikace, cms, redakční systém');
define('_WEBSITE_FOOTER', "Používá technologii XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>The XOOPS Project</a>");
define('_WEBSITE_COPYRIGHT', 'Copyright © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS je dynamický objektově orientovaný skript portálu s otevřeným zdrojovým kódem napsaný v PHP.');
define('_WEBSITE_CENSOR_REPLACE', 'Jejda');
// 2.7.1
